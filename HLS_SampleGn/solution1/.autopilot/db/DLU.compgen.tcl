...
set TrueReset 0
set IsROM 0
set ROMData { "00111110000000001011111101101100" "00111110000001110100011001111111" "00111111001000111111001010111101" "00111101110101101101010111100000" "00111111000010010010000110100001" "00111110101110010010001011111101" "00111111101001101110100101111001" "00111111011100100111001111100110" "00111111001101000010011111111110" "00111111101000011111100101010101" "00111111000111111000111011101010" "00111101001010010100010101101110" "01000000000101001100110101001110" "00111110011000000000101011101100" }
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 51 \
			corename DLU_CRTL_BUS_axilite \
			name DLU_CRTL_BUS_s_axi \
			ports {$port_CRTL_BUS} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler DLU_CRTL_BUS_s_axi
}
