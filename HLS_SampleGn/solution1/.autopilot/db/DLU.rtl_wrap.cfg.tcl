...
set structArgument2 [list 32 2 5 6 ]
set NameSpace2 [list ]
set structIsPacked2 "0"
set DataType2 [list "ap_axis<32, 2, 5, 6>" "struct ap_axis" $structMem2 1 0 $structParameter2 $structArgument2 $NameSpace2 $structIsPacked2]
