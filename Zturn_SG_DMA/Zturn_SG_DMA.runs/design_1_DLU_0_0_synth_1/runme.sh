...
HD_PWD='D:/MLU/Zturn_SG_DMA/Zturn_SG_DMA.runs/design_1_DLU_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_DLU_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_DLU_0_0.tcl
